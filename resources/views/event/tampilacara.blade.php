...
<h1 class="text-center mb-5">Ubah Data</h1>
  <div class="container" >
      <div class="row justify-content-center" >
       <div class="col-8">
<div>
<div>
<form action="/updateacara/{{ $data->id }}" method="POST" enctype="multipart/form-data" >
 @csrf
...
<div class="form-group">
    ...
    <select class="custom-select" name="tempat" aria-label="Default select example">
      <option selected>{{ $data->tempat }}</option>
...
<div class="form-group">
  ...
  <input type="text" name="pembawa" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->pembawa }}">
