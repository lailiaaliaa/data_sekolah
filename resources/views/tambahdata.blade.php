...
<br><br>
  ...
  <div class="form-group">
    ...
    <input type="number" name="npsn" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
...
<div class="form-group">
  ...
  <input type="radio" id="customRadio1"  name="status"  value="Laki-laki" class="custom-control-input">
  <label class="custom-control-label" for="customRadio1">Laki-Laki</label>
</div>
<div class="custom-control custom-radio">
  <input type="radio"  id="customRadio2" name="status"  value="Perempuan" class="custom-control-input">
...
<div class="form">
    ...
    <input type="file" name="logo" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp">
